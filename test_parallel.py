...
if __name__ == '__main__':
    ...
    out_dir = Path(r'D:\Data\Playground\test\20260429\test_output_parallel')
    ...
    pairs = [(stem, str(src_files[stem]), str(tar_files[stem]), str(out_dir))
    ...
    print(f"Done: success={success}, fail={fail}, total_time={t1-t0:.2f}s, avg_per_image={(t1-t0)/len(pairs)*1000:.2f}ms")
